...
// Read Sliders
  Slider1 = analogRead(A10); // Potentiometer signal or Hall effect sensor connects to this analog pin
  Slider2 = analogRead(A10); // Potentiometer signal or Hall effect sensor connects to this analog pin
